...
export function TripPlanner({ onPlanned }: { onPlanned: (tripId: string) => void }) {
  ...
  return (
    <form onSubmit={submit} className="card-chamfer space-y-4 border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400">
        ...
        <input
          className="input-chamfer mt-1 py-2 font-mono text-xs"
          value={warehouseId}
      ...
      <button
        type="submit"
        disabled={busy}
        className="chamfer-control min-h-12 w-full bg-primary-700 px-4 py-3 text-sm font-medium text-white hover:bg-primary-800 disabled:opacity-50 sm:min-h-0 sm:w-auto sm:py-2"
      >
