...
interface BorderGlowProps {
  children?: ReactNode;
  className?: string;
  /** Inner content wrapper classes. Default `overflow-auto`; use `overflow-visible` so outer glow is not clipped. */
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-[1] flex flex-col ${contentClassName}`}>
        {children}
      </div>
    </div>
  );
