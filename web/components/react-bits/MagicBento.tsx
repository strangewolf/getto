...
export interface BentoProps {
  /** When set, renders these cards instead of the built-in demo set (e.g. dashboard KPIs). */
  items?: BentoCardProps[];
  /** Extra classes on the outer bento grid wrapper (e.g. max-w-full). */
